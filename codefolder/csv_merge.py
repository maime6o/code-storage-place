#----本スクリプトの利用ガイド-----
print("1.pyファイルを指定のディレクトリに保存してください。")
print("2.棚卸対象のexcelに01、02とプレフィックスを付与してください。")
print("3.大前提として対象のcsvには、必ずheader行が必要です。")
print("4.pandasをインストールしていない場合は、事前にCLI上でpip install pandasでインストールをしてください。\nまた会社で使う場合は、情報システム部門にossを使っても良いのか必ず確認してください。\npandasは、規約上商用利用可能なossです。")
